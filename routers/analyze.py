...
from services.analyze_service import analyze_emotion_logic  # ✅ 정확한 import
import os
from services.analyze_service import analyze_emotion, check_and_increment_call_count  # 이미 있는 감정 분석 함수 + 제한 함수
from datetime import datetime, timedelta
from services.analyze_service import redis_client, get_seconds_until_midnight
...
async def analyze_message(data: AnalyzeRequest):
    ...
    try:
        result = analyze_emotion_logic(data.message, data.relationship)
        return result
